...
pkgbuild --root dist_pyinstaller/${PACKAGE_NAME} --identifier de.mpg.biochem.${PACKAGE_NAME}.app --version 0.4.1 --install-location /Applications/AlphaPeptStats.app --scripts release/macos/scripts AlphaPeptStats.pkg
