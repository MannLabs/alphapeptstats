...
pkgbuild --root dist/alphastats --identifier de.mpg.biochem.alphastats.app --version 0.6.7--install-location /Applications/AlphaPeptStats.app --scripts scripts alphastats.pkg
