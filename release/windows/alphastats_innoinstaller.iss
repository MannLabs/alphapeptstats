...
[Files]
Source: "..\..\dist_pyinstaller\alphapeptstats_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\dist_pyinstaller\alphapeptstats_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
