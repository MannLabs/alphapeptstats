...
class TestMaxQuantLoader(BaseTestProteinObject.BaseTest):
    def setUp(self):
        ...
        self.obj = proteinObject(loader=self.loader, metadata_path = "testfiles/maxquant_metadata.xlsx", 
...
class TestDIANNLoader(BaseTestProteinObject.BaseTest):
    def setUp(self):
        ...
        self.obj = proteinObject(loader=self.loader, metadata_path = "testfiles/diann_metadata.xlsx", 
...
class TestFragPipeLoader(BaseTestProteinObject.BaseTest):
    def setUp(self):
        ...
        self.obj = proteinObject(loader=self.loader, metadata_path = "testfiles/fragpipe_metadata.xlsx",  
        sample_column = "analytical_sample external_id")
